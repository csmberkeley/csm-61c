...
$10.625 = 8 + 2 + \frac{1}{2} + \frac{1}{8} \rightarrow 1010.101_2$ in binary\\
$1010.101_2 = 1.010101_2 * 2^3$ $\rightarrow$ Exp $- 127 = 3$\\
...
\begin{solution}[0.5in]
Only possibility is if the exponent is within the range $[0, 127]$, as any value $> 127$ would make the float $>= 2$. 
Then, we can have any permutation of the significand without increasing the number by more than $1$. Thus, there are $2^{7} \times 2^{23} = 2^{30}$ floats $< 2$.
\end{solution}
