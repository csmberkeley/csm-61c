...
\part
Let n be your answer in part (a). Suppose that \lstinline$blt$’s branch immediate is in units of instructions (i.e. an immediate of value 1 means branching 1 instruction away). What is the maximum number of bytes a \lstinline$blt$ instruction can jump forwa\lstinline$rd$ from the current \lstinline$pc$ using these assumptions? Write your answer in terms of n.
\begin{solution}[0.5in]
$(2^{n - 1} − 1) ∗ 17$ \\
