...
\part
Assume register \lstinline$s0 = 0x1000 0000$, \lstinline$s1 = 0x4000 0000$, \lstinline$PC = 0xA000 0000$. Let’s analyze the instruction \lstlinline$jalr s0, s1, MAX_POS_IMM$ where \lstlinline$MAX_POS_IMM\lstlinline$ is the maximum possible positive immediate for \lstlinline$jalr$. Using the register sizes defined above, what are the values in registers \lstlinline$s0$, \lstlinline$s1$, and \lstlinline$pc$ after the instruction executes?
