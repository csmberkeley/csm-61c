...
1 GHz * 0.02 ms * $10^{-3}$ s/ms = 20000 cycles
\end{solution}

\part
How many polling iterations does it take to read 1 byte of data? (round up to an integer)
\begin{solution}[0.5in] 
20,000 cycles / 60 cycles/iteration = 334 iterations
\end{solution}

\part
How many cycles does it take to read the 1000 bytes of data?
\begin{solution}[0.5in] 
334 iterations/byte * 1000 bytes * 60 cycles/iteration = 20,040,000 cycles
\end{solution}
\end{parts}
