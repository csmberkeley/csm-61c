...
% \rule{1cm}{0.15mm} The page table is stored in main memory.\\
% \rule{1cm}{0.15mm} Every virtual page is mapped to a physical page.\\
% \rule{1cm}{0.15mm} The TLB is checked before the page table.\\
% \rule{1cm}{0.15mm} The penalty for a page fault is about the same as the penalty for a cache miss.\\
% \rule{1cm}{0.15mm} A linear page table takes up more memory as the process uses more memory.

% \begin{solution}[0.5in]
% True - The page table is stored in main memory.\\
% False - Every virtual page is mapped to a physical page.\\
% True - The TLB is checked before the page table.\\
% False - The penalty for a page fault is about the same as the penalty for a cache miss.\\
% False - A linear page table takes up more memory as the process uses more memory.
% \end{solution}
